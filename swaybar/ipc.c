...
static void ipc_parse_colors(
	...
	struct {
		...
		{ "focused_title_border", &config->colors.focused_title.border },
		{ "focused_title_bg", &config->colors.focused_title.background },
		{ "focused_title_text", &config->colors.focused_title.text },
